    ...
    public class Tests
    {
        ...
        public void Setup()
        {
            ...
            var books = new List<Book>
            {
                new Book
                {
                    Id = Guid.NewGuid(), Name = "Книга1", Rating = 3,
                    ...
                    Description = "Описание", Language = russian, PageCount = 438,
                    PublicationDate = DateTime.Now.AddDays(new Random().Next(0, 100))
                },
                new Book
                {
                    Id = Guid.NewGuid(), Name = "Книга2", Rating = 4.5,
                    PublishingHouses = new List<PublishingHouse> {juventus},
                ...
                new Book
                {
                    Id = Guid.NewGuid(), Name = "Книга3", Rating = 4,
                    PublishingHouses = new List<PublishingHouse> {juventus},
                ...
                new Book
                {
                    Id = Guid.NewGuid(), Name = "Книга4", Rating = 5,
                    PublishingHouses = new List<PublishingHouse> {juventus},
                ...
                new Book
                {
                    Id = Guid.NewGuid(), Name = "Книга5", Rating = 2.6,
                    PublishingHouses = new List<PublishingHouse> {juventus},
                ...
                new Book
                {
                    Id = Guid.NewGuid(), Name = "Книга6", Rating = 4.7,
                    PublishingHouses = new List<PublishingHouse> {juventus},
                ...
                new Book
                {
                    Id = Guid.NewGuid(), Name = "Книга7", Rating = 3.2,
                    PublishingHouses = new List<PublishingHouse> {juventus},
                ...
                new Book
                {
                    Id = Guid.NewGuid(), Name = "Книга8", Rating = 3.6,
                    PublishingHouses = new List<PublishingHouse> {juventus},
                ...
                new Book
                {
                    Id = Guid.NewGuid(), Name = "Книга9", Rating = 1,
                    PublishingHouses = new List<PublishingHouse> {juventus},
                ...
                new Book
                {
                    Id = Guid.NewGuid(), Name = "Книга10", Rating = 2.8,
                    PublishingHouses = new List<PublishingHouse> {juventus},
                ...
                new Book
                {
                    Id = Guid.NewGuid(), Name = "Книга11", Rating = 3.1,
                    PublishingHouses = new List<PublishingHouse> {juventus},
                ...
                new Book
                {
                    Id = Guid.NewGuid(), Name = "Книга12", Rating = 4.9,
                    PublishingHouses = new List<PublishingHouse> {juventus},
                    Genres = new List<Genre> {drama}, Authors = new List<Author> {author1},
                ...
                new Book
                {
                    Id = Guid.NewGuid(), Name = "Книга13", Rating = 4.4,
                    PublishingHouses = new List<PublishingHouse> {juventus},
                ...
                new Book
                {
                    Id = Guid.NewGuid(), Name = "Книга14", Rating = 3.9,
                    PublishingHouses = new List<PublishingHouse> {juventus},
                ...
                new Book
                {
                    Id = Guid.NewGuid(), Name = "Книга15", Rating = 4.5,
                    PublishingHouses = new List<PublishingHouse> {juventus},
